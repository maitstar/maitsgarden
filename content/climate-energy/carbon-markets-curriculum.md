---
title: Carbon Markets Curriculum
tags: [climate, carbon-markets, VCM, compliance, methane, agriculture, India]
related: ["[[ccus]]", "[[readme]]", "[[3A-principles]]"]
sources: ["[[00- Raw/Energy/Comprehensive Carbon Markets Curriculum.md]]"]
...
Structured learning path in three phases: foundational knowledge → advanced mechanisms → specialized focus (methane, agriculture, Indian markets).
...
**Two market types:**
- **Compliance markets** — mandatory, government-regulated cap-and-trade (EU ETS)
- **Voluntary carbon markets (VCM)** — optional offsetting; covers <1% of global emissions
...
- **Verra (VCS)** — most widely used; rigorous certification and registry management
- **Gold Standard** — emphasizes emission reductions AND sustainable development co-benefits
- **American Carbon Registry (ACR)** — transparency focus

**Project lifecycle:** Design → Validation → Implementation → Verification → Credit issuance

**Key concept: Additionality** — proving emission reductions wouldn't have occurred without carbon finance. Critical for project integrity.

**MRV protocols:** Monitoring, Reporting, Verification — plus baseline setting and leakage assessment.
...
**Agricultural carbon — key initiative:** CIMMYT-ICAR voluntary offset program with 2,000+ smallholder farmers in Punjab, Haryana, Maharashtra. Geo-tagging + remote sensing for monitoring. Regenerative agriculture interventions → 10–20 year payment streams.
...
**Why it matters:** Rice paddies = ~10% of global methane emissions. Flooded paddies → anaerobic conditions → methanogenesis. Pre-2024, rice credits = ~30% of all agricultural VCM credits (99% from China).

**Key intervention — Alternate Wetting and Drying (AWD):**
...
**Resources:** IRRI AWD guides, RMI "Technical Explainer: Carbon Credits for Improved Rice Cultivation", FAO water management guidelines
...
2. Build Excel model for carbon project economics — development costs, credit projections, revenue scenarios
